...
renderer.setClearColor("rgb(227, 250, 234)");
...
const loader = new GLTFLoader().load(
  "./assets/donut.glb", // comment this line out and un comment the line below to swithc models
  ...
  function(gltf) {
    ...
    mesh.rotation.set(25.5, 0, 0);
    mesh.scale.set(1.5, 1.5, 1.5); // <-- change this to (1, 1, 1) for photogrammetery model
    // Add model to scene
    scene.add(mesh);
  },
  undefined,
