...
function manualAnimation() {
  if (ticker == 0) {
    if (mesh2.position.y >= 0 && mesh2.position.y < 0.5) {
      mesh2.position.y += 0.00341;
    }
    if (mesh2.position.y >= 0.5) {
      mesh2.position.x += 0.00341;
    }
    if (mesh2.position.y <= 0.5 && mesh2.position.x >= 1) {
  ...
  if (ticker == 1) {
    if (mesh2.position.y >= 0.5) {
      mesh2.position.y -= 0.00342;
    }
    // if (mesh2.position.y >= 0 && mesh2.position.y < 0.5) {
    //   mesh2.position.y += 0.00341;
    // }
    // if (mesh2.position.x >= 0 && mesh2.position.x < 0.5) {
    //   mesh2.position.x += 0.00341;
    // }
